"use client";
//export const dynamic = "force-dynamic"; // Ensures this page is never prerendered
...
export default function UserLoginPage() {
  ...
  useEffect(() => {
    if (searchParams.get("type") === "recovery" || searchParams.get("token")) {
      setView("reset");
    }
  }, [searchParams]);
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (gymData) router.push("/partner-dashboard");
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        "Account created! Check your email to verify your account, then you can log in."
      );
      setView("login");
      setLoading(false);
    } catch (err: any) {
