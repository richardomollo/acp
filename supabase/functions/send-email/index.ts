...
const FROM = 'Lana <noreply@activecitypass.com>'
...
function guestBookingConfirmation(d: any) {
  ...
  return wrap(`
    ...
    ${signupCta(d.email)}
    <div style="${foot}">Lana | Nairobi, Kenya<br>
...
function newBooking(d: any) {
  return wrap(`
    ...
    <div style="${foot}">Lana | Nairobi, Kenya</div>
  `)
}

function welcome(d: any) {
  return wrap(`
    <h1 style="${h1}">Welcome to Lana Pro! 🎉</h1>
    <p style="${p}">Hi ${d.businessName},</p>
...
function customerWelcome(d: any) {
  return wrap(`
    <h1 style="${h1}">Welcome to Lana! 🎉</h1>
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">Your account is ready. Lana is Nairobi's flexible sports & wellness membership — one pass, 50+ venues, and a growing set of communities and clubs to move with.</p>
    <div style="${card}">
    ...
    <a href="https://activecitypass.com/sessions" style="${btn}">Explore Lana →</a>
    <div style="${foot}">Lana | Nairobi, Kenya<br>
      <a href="mailto:info@activecitypass.com" style="color:#aaa;">info@activecitypass.com</a></div>
  `)
}
...
function communityWelcome(d: any) {
  return wrap(`
    ...
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">You're in! You've joined <strong>${d.communityName}</strong> on Lana — get ready to meet your people and show up together.</p>
    <div style="${card}">
...
function firstPayout(d: any) {
  return wrap(`
    ...
    <p style="${p}">Hi ${d.businessName},</p>
    <p style="${p}">Congratulations — you've just received your first payout of <strong>KES ${d.amount}</strong> from Lana!</p>
    <a href="https://activecitypass.com/partner-dashboard" style="${btn}">View Dashboard</a>
    <div style="${foot}">Lana | Nairobi, Kenya</div>
  `)
}
...
function partnerSetupIncomplete(d: any) {
  ...
  return wrap(`
    ...
    <p style="${p}">Hi ${d.businessName},</p>
    <p style="${p}">Your Lana listing has been live for a while, but it's still missing a couple of things that keep customers from booking with you.</p>
    <div style="${card}">
...
function partnerApplicationReceived(d: any) {
  return wrap(`
    ...
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">Thanks for applying to join Lana as a <strong>${d.partnerType}</strong>. We're excited to have you on board!</p>
    <div style="${card}">
...
function partnerApplicationAlert(d: any) {
  return wrap(`
    ...
    <p style="${p}">A new partner has submitted an application on Lana.</p>
    <div style="${card}">
...
function communityApplicationReceived(d: any) {
  return wrap(`
    ...
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">Thanks for submitting <strong>${d.communityName}</strong> to Lana. We're excited to have you on board!</p>
    <div style="${card}">
      <p style="margin:0 0 6px;font-size:14px;font-weight:700;color:#333;">What happens next</p>
...
function communityApplicationAlert(d: any) {
  return wrap(`
    ...
    <p style="${p}">A new community has been submitted for review on Lana.</p>
    <div style="${card}">
...
function partnerApproved(d: any) {
  ...
  return wrap(`
    <h1 style="${h1}">You're approved! Welcome to Lana 🎉</h1>
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">Great news — your application as a <strong>${d.partnerType}</strong> has been approved. Your profile is now live on Lana!</p>
    <div style="${card}">
...
function trainerInvite(d: any) {
  return wrap(`
    ...
    <p style="${p}"><strong>${d.gymName}</strong> has added you as a trainer on Lana. Set a password to finish setting up your account and start managing your assigned classes and students.</p>
...
function partnerRejected(d: any) {
  return wrap(`
    ...
    <p style="${p}">Hi ${d.name},</p>
    <p style="${p}">Thank you for your interest in joining Lana. After reviewing your application, we're unfortunately unable to approve it at this time.</p>
...
function withdrawalRequest(d: any) {
  ...
  return wrap(`
    ...
    <p style="${p}">A partner has submitted a withdrawal request on Lana.</p>
    <div style="${card}">
...
function feedbackRequest(d: any) {
  return wrap(`
    ...
    <p style="${p}">Thanks for joining ${d.activityName}. Got a minute to tell us how it went? It only takes 30 seconds and helps us make Lana better.</p>
...
serve(async (req) => {
  ...
  try {
    ...
    switch (type) {
      ...
      case 'welcome':
        html = welcome(data)
        subject = 'Welcome to Lana Pro!'
        break
      case 'customer_welcome':
        html = customerWelcome(data)
        subject = 'Welcome to Lana! 🎉'
        break
      ...
      case 'partner_setup_incomplete':
        ...
        subject = `${data.businessName}, your Lana listing isn't finished yet`
        break
      case 'partner_application_received':
        html = partnerApplicationReceived(data)
        subject = 'We\'ve received your Lana partner application'
        break
      ...
      case 'partner_approved':
        ...
        subject = 'You\'re approved! Welcome to Lana 🎉'
        break
      case 'partner_rejected':
        html = partnerRejected(data)
        subject = 'Update on your Lana partner application'
        break
      case 'trainer_invite':
