  ...
  const loadMembershipDetails = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from('users')
        .select('credits, subscription_tier, subscription_status, trial_credits_used, trial_start_date, trial_end_date, subscription_start_date, subscription_end_date')
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.planCard}>
          <View style={styles.planHeader}>
            ...
            <Ionicons name="diamond-outline" size={48} color="#002fff" />
          </View>

          <View style={styles.creditsDisplay}>
            <ThemedText style={styles.creditsValue}>{membership?.credits || 0}</ThemedText>
        ...
        <View style={styles.section}>
          ...
          {membership?.trial_end_date && (
            <View style={styles.detailItem}>
              ...
              <ThemedText style={styles.detailValue}>
                {formatDate(membership.trial_end_date)}
              </ThemedText>
            </View>
          )}

          <View style={styles.detailItem}>
            <ThemedText style={styles.detailLabel}>Trial Credits Used</ThemedText>
            <ThemedText style={styles.detailValue}>
              {membership?.trial_credits_used || 0}
            </ThemedText>
          </View>
        </View>
