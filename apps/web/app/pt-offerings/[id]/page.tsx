...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  if (!offering) return { title: "PT Session | Active CityPass" };
  ...
  const description = offering.description ?? `Book a personal training session with ${name} on Active CityPass in Nairobi.`;
