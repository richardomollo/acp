...
// This marketing page renders ONLY when the Lana Pro cutover is off (the
// `page.tsx` wrapper redirects to /lana-pro/onboarding otherwise), so every
// signup CTA here targets the classic wizard.
...
const BENEFITS = [
  {
    ...
    body: "Tap into thousands of active, health-conscious Nairobians searching for their next session, PT, class, or experience. Most Lana users are first-time visitors to the partners they book.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    body: "Convert Lana visitors into long-term clients. Whether you run a studio, coach one-on-one, or host experiences — our platform helps you showcase what makes you different.",
  },
];
...
const STEPS = [
  ...
  { n: "04", title: "Start Earning", body: "Clients book through Lana. You get paid per confirmed visit — no long-term contracts, no lock-in." },
];
...
const TESTIMONIALS = [
  ...
  {
    quote: "Our Saturday slots used to run at 60% capacity. Now they're routinely full. Lana members are exactly our target demographic.",
    name: "David Ouma",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Clients pay Lana at the time of booking. We pay you per confirmed visit at your agreed rate. Payouts are processed monthly, directly to your M-Pesa or bank account.",
  },
  {
    q: "Will this affect my existing clients?",
    a: "No. You control exactly what you list — specific sessions, time slots, or experiences. Lana only fills availability you've already made available, so your existing clients and regulars are never displaced.",
  },
  {
          ...
          <div className="grid lg:grid-cols-1 gap-12 items-center">
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed max-w-2xl">
               Join Lana to reach thousands of active Nairobians, fill empty slots, and let us handle discovery, bookings, payments, and support—so you can focus on coaching and delivering exceptional fitness experiences.
              </p>
      ...
      <section id="benefits" className="py-14 ">
        <div className="max-w-7xl mx-auto px-6 md:px-16 text-center">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Lana handles discovery, payments, and customer support — so you can focus on delivering great sessions, classes, and experiences.
          </p>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            Join gyms, personal trainers, coaches, studios, and wellness venues already growing on Lana.
