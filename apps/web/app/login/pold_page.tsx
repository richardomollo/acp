...
export default function LoginPage() {
  ...
  <p className="mx-auto mt-6 max-w-2xl text-center text-sm ext-base/7 text-pretty text-gray-600">Your first month is on us! 💪 Try activities for individuals, partners, kids, and families — train, play, and unwind anytime with gyms, classes, and wellness experiences on FitPass. Free for 1 month. Start today!</p>
